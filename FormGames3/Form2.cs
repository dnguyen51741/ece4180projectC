...
namespace FormGames3
{
    public partial class Form2 : Form
    {
        ...
        SoundPlayer song1 = new SoundPlayer(@"../../Resources/Frank_Sinatra_have_Yourself_A_Merry_LIttle_Christmas_Lyrics-sHVIVNoIPVM.wav");
        ...
        private void mainGameTimer(object sender, EventArgs e)
        {
            ...
            foreach (Control x in this.Controls)
            {
                if (x is PictureBox && x.Tag == "platform")
                {
                    ...
                    if (enemy.Bounds.IntersectsWith(x.Bounds) && !jumping)
                    {
                        force = 8;
                    ...
                    if (enemy2.Bounds.IntersectsWith(x.Bounds) && !jumping)
                    {
                        force = 8;
                    ...
                    if (enemy3.Bounds.IntersectsWith(x.Bounds) && !jumping)
                    {
                        force = 8;
            ...
            {
                door.Image = Properties.Resources._1543214269589854__2_;
                ...
                serialPort2.Close();
                serialPort1.Close();
                Form3 gameScreen = new Form3(score);
                gameScreen.Show();
                this.Close();
                gameTimer.Stop();
